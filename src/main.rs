...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        App::new()
            ...
            .service(construct_post_onlyrights!("/api/editTypography", edit_typography, 3))
            .service(construct_post_onlyrights!("/api/newAuthor", new_author, 4))
            .service(construct_post_onlyrights!("/api/editAuthor", edit_author, 4))
            .service(construct_post_onlyrights!("/api/newOrdermaker", new_ordermaker, 5))
            .service(construct_post_onlyrights!("/api/editOrdermaker", edit_ordermaker, 5))
